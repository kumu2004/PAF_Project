git checkout Facilities-and-Assets-Catalogue
git reset d3e8912

$global:dates = @("2026-04-11", "2026-04-12", "2026-04-13", "2026-04-15", "2026-04-16", "2026-04-17")
$global:commitIndex = 0

function Commit-WithDate {
    param([string]$message)
    
    $dayIndex = [math]::Floor($global:commitIndex / 3.5)
    if ($dayIndex -ge 6) { $dayIndex = 5 }
    ...
    $env:GIT_AUTHOR_NAME = "themiya02"
    $env:GIT_AUTHOR_EMAIL = "themiya02@gmail.com"
    $env:GIT_COMMITTER_NAME = "themiya02"
    $env:GIT_COMMITTER_EMAIL = "themiya02@gmail.com"
